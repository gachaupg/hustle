...
router.post('/', async(req, res)=> {
  ...
  try {
    const {name,discountPrice,location,age ,specifications,brand,infoAdd, description, discountPercentage, price, category, images: pictures} = req.body;
  const discount = Math.round(price*(1-discountPercentage/100))
// const items=product._id
    const product = await Product.create({location,age,brand,specifications,infoAdd,creator: req.userId,name, discountPrice:discount,discountPercentage, description, price, category, pictures});
